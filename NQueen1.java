...
/*Zgjidh zgjidh enigmën N-Queens duke përdorur Algoritmin gjenetik.
 * Kodi bazohet në algortihm gjenetik të crossover pjesërisht të hartuar për n mbretëreshat */
...
public class NQueen1
{
    ...
    public static String[][] matrica;

    private static ArrayList<Chromosome> population = new ArrayList<Chromosome>();
    public NQueen1()
    {
        String a = JOptionPane.showInputDialog("How many Queens do u want !");
        MAX_LENGTH = new Integer(a).intValue();
    }
        ...
        if(epoch != MAX_EPOCHS){
            ...
            for(int i = 0; i < popSize; i++)
            {
                ...
                if(thisChromo.conflicts() == 0){
                    matrica = printbestSolution(thisChromo);
                }
            }
        }
    ...
    private static String[][] printbestSolution(Chromosome bestSolution)
    {
    ...
    public static void main(String[] args) {
        NQueen1 a = new NQueen1();
        //for (String[]a)

        a.algorithm();
        Vizatuese b = new Vizatuese(MAX_LENGTH,matrica);
    }
}